...
class Article(models.Model):
    ...
    pub_date = models.DateTimeField(auto_now=True,editable=True)
    update_time = models.DateTimeField(auto_now=True,null=True)
    published = models.BooleanField('notdradt',default=True)
...
class Author(models.Model):
    ...
    register_date = models.DateTimeField(auto_now=True,editable=True)
